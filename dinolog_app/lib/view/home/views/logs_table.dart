                ...
                children: [
                  Table(
                    ...
                    children: [
                      ...
                      // ---- DATA
                      for (final LogEntry logEntry
                          in asyncSnapshot.data?.entries ?? [])
                        TableRow(
                          children: [
                            SizedBox(height: 48),
                            Text(
                            ...
                            InkWell(
                              onTap: () {
                                launchUrl(
                                  Uri.parse(
                                    'https://ipinfo.io/${logEntry.remoteAddr}',
                                  ),
                                );
                              },
                              child: FutureBuilder(
                            ...
                            Text(
                              logEntry.httpMethod,
                              style: Theme.of(context).textTheme.labelSmall!
                                  .copyWith(color: DinologTheme.accentSuccess),
                            ),
                            Text(
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: DinologTheme.accentSuccess.withAlpha(
                                    50,
                                  ),
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: Text(
                            'Préc',
                            style: Theme.of(context).textTheme.labelSmall!
                                .copyWith(color: DinologTheme.textPrimary),
                          ),
                        ),
                        SizedBox(width: 8.0),
                        ElevatedButton(
